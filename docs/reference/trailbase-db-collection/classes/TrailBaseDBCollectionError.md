...
- [`TimeoutWaitingForIdsError`](TimeoutWaitingForIdsError.md)
- [`ExpectedInsertTypeError`](ExpectedInsertTypeError.md)
- [`ExpectedUpdateTypeError`](ExpectedUpdateTypeError.md)
- [`ExpectedDeleteTypeError`](ExpectedDeleteTypeError.md)
...
```ts
new TrailBaseDBCollectionError(message): TrailBaseDBCollectionError;
```

Defined in: [packages/trailbase-db-collection/src/errors.ts:5](https://github.com/TanStack/db/blob/main/packages/trailbase-db-collection/src/errors.ts#L5)
